...
.${TemplateClass.fediverseStatus} header a, .${TemplateClass.fediverseStatus} footer {
...
.${TemplateClass.fediverseStatus} header .post-authors-fediverse-identity {
...
.${TemplateClass.fediverseStatus} footer .counter-favourites::before {
	content: "★";
	color: rgb(96 ,96 ,96 ,1);
	margin-inline-end: .25em;          
}

.${TemplateClass.fediverseStatus} footer .counter-reblogs::before {
